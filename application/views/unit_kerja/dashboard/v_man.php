        <div class="box">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">
                 <div class="info-box" style="background-color: #F7464A; color: white">
                    <span class="info-box-icon"><?= $jumlah ?></span>

                    <div class="info-box-content"><br/>
                      <span class="info-box-text"><h3>Penyebab Risiko - Man</h3></span>
                    </div>
                  </div>
              </h3>
            ...
            <div class="box-body">
              <table id="pernyataanRisk" class="table table-responsive table-striped table-hover table-bordered">
                 <thead>
                   <tr style="background-color: #F7464A; color: white">
                     <th>No</th>
