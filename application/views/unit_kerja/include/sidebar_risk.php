  ...
  <div class="leftcolumn w3-animate-top">
    <div class="card">
      ...
      <div class="w3-panel" style="width:100%">
        <a class="w3-button w3-block w3-teal" id="rencanaRisk">Rencana Penanganan Risiko</a>
      </div>
      <div class="w3-panel" style="width:100%">
        <a  class="w3-button w3-block w3-teal" id="realisasiRisk">Realisasi Penanganan Risiko</a>
      </div>
      <div class="w3-panel" style="width:100%">
        <a  class="w3-button w3-block w3-teal" id="uploadZip">Upload File ZIP</a>
      </div>
    </div>
    <div class="card">
