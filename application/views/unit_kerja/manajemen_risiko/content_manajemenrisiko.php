  ...
  <div class="leftcolumn w3-animate-bottom">
    <div class="card">
      <div class="w3-panel" style="width:100%">
        <a href="<?= base_url('unit_kerja/manajemen_risiko/identifikasi_risiko') ?>" class="w3-button w3-block w3-teal sidebar" id="default">Identifikasi Risiko</a>
      </div>
      <div class="w3-panel" style="width:100%">
        <a href="<?= base_url('unit_kerja/manajemen_risiko/daftar_risiko') ?>" class="w3-button w3-block w3-teal sidebar">Daftar Risiko</a>
      </div>
      <div class="w3-panel" style="width:100%">
        <a href="<?= base_url('unit_kerja/manajemen_risiko/rencana_penanganan') ?>" class="w3-button w3-block w3-teal sidebar">Rencana Penanganan Risiko</a>
      </div>
      <div class="w3-panel" style="width:100%">
        <a href="<?= base_url('unit_kerja/manajemen_risiko/realisasi_penanganan') ?>" class="w3-button w3-block w3-teal sidebar">Realisasi Penanganan Risiko</a>
      </div>
    </div>
    <div class="card">
