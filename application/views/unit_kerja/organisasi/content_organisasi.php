  ...
  <div class="leftcolumn w3-animate-bottom">
    <div class="card">
      <div class="w3-panel" style="width:100%">
        <a  href="<?= base_url('unit_kerja/organisasi/unit') ?>" class="w3-button w3-block w3-teal sidebar" id="default">Unit Kerja</a>
      </div>
      <div class="w3-panel" style="width:100%" id="navigasi">
        <a href="<?= base_url('unit_kerja/organisasi/pegawai') ?>" class="w3-button w3-block w3-teal sidebar">Pegawai</a>
      </div>
    </div>
