<div class="leftcolumn w3-animate-bottom">
    <div class="card">
      <div class="w3-panel" style="width:100%">
        <a href="<?= base_url('unit_kerja/kegiatan_proses/pk') ?>" class="w3-button w3-block w3-teal sidebar" id="default">Perjanjian Kinerja</a>
      </div>
      <div class="w3-panel" style="width:100%">
        <a href="<?= base_url('unit_kerja/kegiatan_proses/skp') ?>" class="w3-button w3-block w3-teal sidebar">Sasaran Kerja Pegawai</a>
      </div>
      <div class="w3-panel" style="width:100%">
        <a href="<?= base_url('unit_kerja/kegiatan_proses/sop') ?>" class="w3-button w3-block w3-teal sidebar">Standar Operasional Prosedur</a>
      </div>
    </div>
    <div class="card">
